...
# --------------------- Buttons ------------------------------- #
x_button_icon = PhotoImage(file="images/wrong.png")
x_button = Button(image=x_button_icon, highlightthickness=0, command=next_card)
x_button.grid(row=1, column=0)

y_button_icon = PhotoImage(file="images/right.png")
y_button = Button(image=y_button_icon, highlightthickness=0, command=already_learned)
